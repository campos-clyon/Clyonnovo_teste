        ...
        <div className="relative z-10 mx-auto max-w-7xl px-6 pb-14 pt-14 lg:px-8 lg:pb-18 lg:pt-18">
          ...
          <div className="max-w-2xl">
            ...
            <div className="mt-6 flex flex-col gap-3 sm:flex-row">
              <Link
                href="/simulador"
                className="inline-flex h-12 items-center justify-center gap-2 rounded-xl bg-acao px-7 text-sm font-semibold text-white shadow-lg shadow-cyan-600/25 transition hover:bg-acao-hover"
              >
              ...
              <a
                ...
                className="inline-flex h-12 items-center justify-center gap-2 rounded-xl bg-[#25D366] px-7 text-sm font-semibold text-whatsapp-tinta shadow-lg shadow-emerald-500/25 transition hover:bg-[#1ebe5d]"
              >
                <svg className="h-4 w-4 text-whatsapp-tinta" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="rounded-xl border border-slate-200 bg-white px-4 py-2.5 shadow-md">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                ...
                <p className="text-xs text-tinta-fraca">{PRAZO_DE_RESPOSTA.porExtenso}</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="mt-4 space-y-2">
              {includedItems.map((item) => (
                <div key={item} className="flex items-start gap-2 rounded-lg border border-slate-100 bg-slate-50 px-3 py-2">
                  <CheckCircle2 className="mt-0.5 h-4 w-4 shrink-0 text-acao" />
                ...
                <tbody className="divide-y divide-slate-100">
                  {pricingTable.map((row) => (
                    <tr key={row.item}>
                      ...
                      <td className="px-4 py-3 text-right font-semibold text-acao">{row.price}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
      ...
      <section className="mx-auto max-w-7xl px-6 py-14 lg:px-8">
        <div className="rounded-2xl border border-slate-200 bg-white p-6 lg:p-8">
          <div className="flex items-start gap-4">
            <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-cyan-100 text-acao">
          ...
          <div className="mt-6 rounded-xl bg-[#F4F8FB] p-5">
            <p className="text-sm font-semibold text-tinta">Quando escolher a CLYON:</p>
        ...
        <div className="mt-6 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
          {keyCities.map((city) => (
            <Link
              ...
              className="group rounded-xl border border-slate-200 bg-white p-4 transition hover:border-cyan-200 hover:shadow-sm"
            >
              <div className="flex items-center gap-2 text-xs font-semibold uppercase tracking-wide text-acao">
                <MapPin className="h-3.5 w-3.5" />
                {city.regionLabel}
              </div>
              <h3 className="mt-2 font-semibold text-slate-900 group-hover:text-acao-hover">
      ...
      <section className="mx-auto max-w-7xl px-6 pb-20 pt-6 lg:px-8">
        <div className="rounded-2xl bg-[#F4F8FB] p-8 text-center lg:p-12">
          ...
          <div className="mt-6 flex flex-col justify-center gap-3 sm:flex-row">
            <Link
              href="/simulador"
              className="inline-flex h-12 items-center justify-center gap-2 rounded-lg bg-acao px-8 font-semibold text-white transition hover:bg-acao-hover"
            >
              Simular Orçamento
            </Link>
            <a
