...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Recolha de camas usadas com desmontagem, carregamento porta a porta e destino licenciado.",
    ...
    <div className="min-h-screen bg-slate-50">
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm lg:p-8">
              <div className="flex items-center gap-3">
                <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-cyan-100">
                  <Bed className="h-6 w-6 text-acao" />
                </div>
                <div>
      ...
      <section className="bg-white py-16 lg:py-20">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <p className="mt-4 max-w-3xl text-base text-slate-600">
            A recolha de uma cama custa, tipicamente, {PRECO_MOVEIS.etiqueta}. O valor depende de vários fatores, e a melhor forma de o saber ao certo é pedir um orçamento com fotos e morada.
          </p>
