  ...
  const handleAnalyze = async () => {
    ...
    const work = (async () => {
      ...
      if (rawFiles.length > 0) {
        // UMA FOTO POR ENVIO, e reduzida antes de sair.
        //
        // Iam todas juntas num só pedido, e o Vercel recusa qualquer pedido com
        // mais de 4,5 MB de corpo — recusa-o à entrada, com 413, sem o ficheiro
        // chegar à nossa função. Duas fotos de telemóvel bastavam para rebentar
        // o lote inteiro, e o cliente ficava sem nenhuma.
        //
