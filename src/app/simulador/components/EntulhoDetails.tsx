...
export default function EntulhoDetails({
  ...
  return (
    <div className="bg-slate-50 rounded-xl border border-slate-200 p-5 space-y-3">
      ...
      {/*
        O BIG BAG SAIU DAQUI.

        Era uma das quatro opções e convertia-se, por trás, em 42 sacos. Só que
        a CLYON não recolhe big bags: um big bag cheio de entulho pesa perto de
        uma tonelada e não há forma de o carregar à mão. Aceitar a escolha era
        aceitar um trabalho que ninguém podia fazer — e o cliente só o descobria
        com o profissional à porta. Ver `sacos-de-entulho.ts`.
      */}
